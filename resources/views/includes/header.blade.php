<header class="blog-header py-3">
    <div class="row flex-nowrap justify-content-between align-items-center">
        ...
        <div class="col-4 d-flex justify-content-end align-items-center">
            ...
            @guest
                <a class="btn btn-sm btn-outline-secondary mr-2" href="{{ route('login') }}">{{ __('Login') }}</a>
            ...
            @else
                ...
                <a id="navbarDropdown" class="nav-link dropdown-toggle btn btn-sm btn-outline-secondary" href="#"
